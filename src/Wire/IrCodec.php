...
namespace Eleph\Gen\Php\Wire;

use BackedEnum;
use Eleph\Gen\Php\Ir\ActionDefinition;
...
use Eleph\Gen\Php\Ir\TriggerDefinition;
use Eleph\Gen\Php\Ir\TriggerEvent;
use Eleph\Gen\Php\Ir\TypeDefinition;
use ReflectionClass;
